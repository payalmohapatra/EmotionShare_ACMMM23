...
set_seed(66)
writer = SummaryWriter(comment = 'lr0.0001concentrationmeanvaluehubertlargeattention')
...
class TrainDataset(Dataset):
    ...
    def __init__(self, train_signal_hubert_transpose, train_emotion, a): ## (a)
...
def train(epoch):
    ...
    writer.add_scalar("0.0001_loss_3_concentration_meanvalue_v2_hubert_large_v2_attention_v3/train", avg_loss, epoch)
...
def evaluate(epoch):
    ...
    with torch.no_grad():
        ...
        writer.add_scalar("0.0001_eval_correlation_3_concentration_meanvalue_v2_hubert_large_v2_attention_v3/devel", correlation_3, epoch)

def save_checkpoint(state, filename='/data/concentrationhubertlargeattentionseed/checkpoint.pth.tar'):
...
for epoch in range(iters):
    ...
    }, filename=f'/data/concentrationhubertlargeattentionseed/epoch_{epoch+1}.pth.tar')
    evaluate(epoch)