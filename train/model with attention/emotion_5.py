...
set_seed(999)
writer = SummaryWriter(comment = 'lr0.0001excitementmeanvaluehubertlargeattention')
...
def train(epoch):
    ...
    writer.add_scalar("0.0001_loss_5_excitement_meanvalue_hubert_large_attention/train", avg_loss, epoch)
...
def evaluate(epoch):
    ...
    with torch.no_grad():
        ...
        writer.add_scalar("0.0001_eval_correlation_5_excitement_meanvalue_hubert_large_attention/devel", correlation_5, epoch)

def save_checkpoint(state, filename='/data/excitementhubertlargeattentionseed/checkpoint.pth.tar'):
...
for epoch in range(iters):
    ...
    }, filename=f'/data/excitementhubertlargeattentionseed/epoch_{epoch+1}.pth.tar')
    evaluate(epoch)