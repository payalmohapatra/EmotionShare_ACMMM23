...
set_seed(66)
writer = SummaryWriter(comment = 'lr0.0001boredommeanvaluehubertlargeattention')
...
def train(epoch):
    ...
    writer.add_scalar("0.0001_loss_1_boredom_meanvalue_hubert_large_attention/train", avg_loss, epoch)
...
def evaluate(epoch):
    ...
    with torch.no_grad():
        ...
        writer.add_scalar("0.0001_eval_correlation_1_boredom_meanvalue_hubert_large_attention/devel", correlation_1, epoch)

def save_checkpoint(state, filename='/data/boredomhubertlargeattentionseed/checkpoint.pth.tar'):
...
for epoch in range(iters):
    ...
    }, filename=f'/data/boredomhubertlargeattentionseed/epoch_{epoch+1}.pth.tar')
    evaluate(epoch)