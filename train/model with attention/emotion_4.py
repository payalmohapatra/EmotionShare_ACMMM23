...
set_seed(999)
writer = SummaryWriter(comment = 'lr0.0001determinationmeanvaluehubertlargeattention')
...
def train(epoch):
    ...
    writer.add_scalar("0.0001_loss_4_determination_meanvalue_hubert_large_attention/train", avg_loss, epoch)
...
def evaluate(epoch):
    ...
    with torch.no_grad():
        ...
        writer.add_scalar("0.0001_eval_correlation_4_determination_meanvalue_v2_hubert_large_v2_attention_v3/devel", correlation_4, epoch)

def save_checkpoint(state, filename='/data/determinationhubertlargeattentionseed/checkpoint.pth.tar'):
...
for epoch in range(iters):
    ...
    }, filename=f'/data/determinationhubertlargeattentionseed/epoch_{epoch+1}.pth.tar')
    evaluate(epoch)