...
set_seed(999)
writer = SummaryWriter(comment = 'lr0.0001angermeanvaluehubertlargeattention')
...
def train(epoch):
    ...
    writer.add_scalar("0.0001_loss_0_anger_meanvalue_hubert_large_attention/train", avg_loss, epoch)
...
def evaluate(epoch):
    ...
    with torch.no_grad():
        ...
        writer.add_scalar("0.0001_eval_correlation_0_anger_meanvalue_hubert_large_attention/devel", correlation_0, epoch)

def save_checkpoint(state, filename='/data/angerhubertlargeattentionseed/checkpoint.pth.tar'):
...
for epoch in range(iters):
    ...
    }, filename=f'/data/angerhubertlargeattentionseed/epoch_{epoch+1}.pth.tar')
    evaluate(epoch)